...
important role in several areas ranging from nuclear physics to the study of random surfaces, 
...
exact analytical expressions and recent bootstrap methods are shown
and many new results for other models are given
to assist future bootstrapping. In order to encourage this exchange,
we provide programs in \PY~which can
be easily modified to study other potentials. 
We hope this will be useful for further numerical/analytical investigations 
of matrix models for those who are not familiar with MC methods. 
The programs we present were tested on a laptop and took between a 
few minutes to several hours to finish depending on the model, $N$, 
