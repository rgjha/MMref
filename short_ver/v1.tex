% v1: November 2021
% v1: Contains 1 Mathematica code, 3 Python codes, 5 tables, 10 exercises, 14 figures, 54 references, 1+54 pages. Codes available at https://github.com/rgjha/MMMC
...
\subsection{Unitary one-plaquette model - Orthogonal polynomials} 
...
unitary (link) matrices. The model is given by the plaquette action which is: 
\begin{equation}
	\label{eq:main1} 
...
plaquette and the sum is over all the plaquettes 
of the two-dimensional square lattice. 
This action is simply the well-known Wilson's lattice action. 
...
One of the two methods we discussed for the analytic solution of
...
solving two matrix models. These polynomials are defined as:
\begin{equation}
	\label{eq:ortho_nn} 
...
quantum mechanics model back in 2015. But, in few months, this disappeared. I thank Simon Catterall for this exercise.} but this is not true. 
