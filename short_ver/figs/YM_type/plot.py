...
x = np.loadtxt("action_N300_D10.txt")
y = np.loadtxt("action_N300_D5.txt")
z = np.loadtxt("action_N300_D3.txt")
...
plt.plot(x, label=r'$D = 10$')
plt.plot(y, label=r'$D = 5$')
plt.plot(z, label=r'$D = 3$')
